...
class HomeController extends GetxController with GetSingleTickerProviderStateMixin{
  ...
  void getProducts() async{
    String? resAllProducts = await NetworkService.GET(NetworkService.API_GET_ALL_PRODUCTS, {});
  ...
  void getCategory() async{
    String? resAllCategory = await NetworkService.GET(NetworkService.API_GET_All_CATEGORY_PRODUCT, {});
